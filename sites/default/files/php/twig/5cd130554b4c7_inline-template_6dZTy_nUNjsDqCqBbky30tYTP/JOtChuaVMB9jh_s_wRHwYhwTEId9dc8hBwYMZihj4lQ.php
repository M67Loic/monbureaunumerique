...
class __TwigTemplate_1c486ea8f9b20c2174ff79d6acd98c87f8d3f25ca9336b635d0c55f2cce428b4 extends \Twig\Template
{
    ...
    {
        return new Source("", "{# inline_template_start #}<span class=\"title\">{{ title }}</span>{% if description or warning %}<div class=\"description\">{% if warning %}<em class=\"permission-warning\">{{ warning }}</em><br />{% endif %}{{ description }}</div>{% endif %}", "");
    }
}
